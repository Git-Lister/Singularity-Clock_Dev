from sqlalchemy import Column, Integer, String, Float, Date, ARRAY, JSON, ForeignKey, Numeric, Boolean
...
class Model(Base):
    ...
    training_compute_flop = Column(Numeric)  # can store huge values
